...
import type { ScrollBoxHandle } from '@marlow/ink'
import { evictInkCaches } from '@marlow/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.MARLOW_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
