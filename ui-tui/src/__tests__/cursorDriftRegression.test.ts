 ...
 *
 * Symptom: in `marlow --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@marlow/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using marlow --tui and as i type multiline my caret at the end will often ' +
