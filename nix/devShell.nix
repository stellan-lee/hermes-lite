...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      marlowNpmLib = self'.packages.default.passthru.marlowNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. marlow-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Marlow Agent dev shell"
          ${combinedNonNpm}
          ${marlowNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}
          echo "Ready. Run 'marlow' to start."
        '';
      };
    };
}
