# nix/web.nix — Marlow Web Dashboard (Vite/React) frontend build
{ pkgs, marlowNpmLib, ... }:
let
  npm = marlowNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "marlow-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../marlow_cli/web_dist for the
