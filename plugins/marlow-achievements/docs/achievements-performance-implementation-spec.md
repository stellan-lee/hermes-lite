# Marlow Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.marlow/plugins/marlow-achievements/state.json` (existing unlock state)
  - `~/.marlow/plugins/marlow-achievements/scan_snapshot.json` (new)
  - `~/.marlow/plugins/marlow-achievements/scan_checkpoint.json` (new)
