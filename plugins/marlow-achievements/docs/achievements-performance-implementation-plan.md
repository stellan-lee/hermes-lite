# Marlow Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.marlow/plugins/marlow-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.marlow/plugins/marlow-achievements/scan_checkpoint.json`.
