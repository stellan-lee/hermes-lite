...
Config via environment variables:
  ...
  MEM0_USER_ID       — User identifier (default: marlow-user)
  MEM0_AGENT_ID      — Agent identifier (default: marlow)

Or via $MARLOW_HOME/mem0.json.
"""
...
def _load_config() -> dict:
    """Load config from env vars, with $MARLOW_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "user_id": os.environ.get("MEM0_USER_ID", "marlow-user"),
        "agent_id": os.environ.get("MEM0_AGENT_ID", "marlow"),
        "rerank": True,
        "keyword_search": False,
    }

    config_path = get_marlow_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._api_key = ""
        self._user_id = "marlow-user"
        self._agent_id = "marlow"
        self._rerank = True
    ...
    def save_config(self, values, marlow_home):
        """Write config to $MARLOW_HOME/mem0.json."""
        import json
        from pathlib import Path
        config_path = Path(marlow_home) / "mem0.json"
        existing = {}
        if config_path.exists():
            try:
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "marlow-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "marlow"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._user_id = kwargs.get("user_id") or self._config.get("user_id", "marlow-user")
        self._agent_id = self._config.get("agent_id", "marlow")
