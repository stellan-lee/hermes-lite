...
required — uses aiohttp which is already a Marlow dependency.
...
def interactive_setup() -> None:
    ...
    ``marlow_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Marlow delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # marlow_cli/setup.py::_setup_mattermost function.
