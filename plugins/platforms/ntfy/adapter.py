"""ntfy platform adapter (Marlow plugin).
...
``plugins/platforms/ntfy/``. The Marlow plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "marlow-in"              # subscribe topic (incoming)
          publish_topic: "marlow-out"     # optional — defaults to topic
...
_ECHO_TAG = "marlow-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``marlow cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Marlow dependency",
