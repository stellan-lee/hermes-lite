...
Config: ~/.marlow/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.marlow/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_marlow_home()`` helper (MARLOW_HOME-aware and
...
RULES_FILE = get_marlow_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_marlow_home() / "feishu_comment_pairing.json"
