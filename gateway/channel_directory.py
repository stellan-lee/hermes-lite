...
~/.marlow/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_marlow_home() / "channel_directory.json"
...
async def build_channel_directory(adapters: Dict[Any, Any]) -> Dict[str, Any]:
    ...
    _SKIP_SESSION_DISCOVERY = frozenset({"local", "webhook"})
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_marlow_home() / "sessions" / "sessions.json"
