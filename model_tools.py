...
#   - cli.py, marlow_cli/*      -> inline on startup (no event loop)
#   - tui_gateway/server.py     -> inline on startup (no event loop)
#   - interactive client adapters -> background-thread session init
...
def _compute_tool_definitions(
    ...
    # This ensures that even if a composite toolset (like marlow-cli)
    ...
    # window). Core Marlow tools (toolsets._MARLOW_CORE_TOOLS) are NEVER
