"""Resolve the small set of inference runtimes retained by Hermes Lite.

Hermes Lite supports Codex authentication/Responses and explicitly configured
...
def resolve_runtime_provider(
    *, requested: Optional[str] = None, explicit_api_key: Optional[str] = None,
    ...
    raise AuthError(
        f"Provider {requested_provider!r} is not included in Hermes Lite. "
