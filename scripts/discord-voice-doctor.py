...
MARLOW_HOME = Path(os.getenv("MARLOW_HOME", Path.home() / ".marlow"))
...
def check_config(groq_key, eleven_key):
    ...
    # Voice mode state
    voice_mode_path = MARLOW_HOME / "gateway_voice_mode.json"
