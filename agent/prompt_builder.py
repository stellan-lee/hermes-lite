...
from marlow_constants import get_marlow_home, get_skills_dir, is_wsl
...
PLATFORM_HINTS = {
    ...
    "webui": (
        "You are in the Marlow WebUI, a browser-based chat interface. "
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines.extend(
        [
            ...
            "Useful commands: marlow setup, marlow setup tools, marlow setup terminal, marlow status.",
        ]
    )
    return "\n".join(lines)
