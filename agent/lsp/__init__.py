"""Language Server Protocol (LSP) integration for Marlow Agent.

Marlow runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``marlow chat`` exit would leak pyright processes that
