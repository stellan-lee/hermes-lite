"""Projects Codex app-server events into OpenAI-shaped conversation messages.
...
The projector also counts completed tool-shaped items for turn diagnostics.
"""
...
class CodexEventProjector:
    ...
    def project(self, notification: dict) -> ProjectionResult:
        ...
        # Record unknown or rare items as opaque assistant notes without
        # fabricating tool-call structure.
