"""
Cron job scheduling system for Marlow Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    marlow gateway install    # Install as a user service
    sudo marlow gateway install --system  # Linux servers: boot-time system service
    marlow gateway            # Or run in foreground
