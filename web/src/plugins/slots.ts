 ...
 * `window.__MARLOW_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Marlow brand in the top bar
 ...
 *  `window.__MARLOW_PLUGINS__.registerSlot(...)`.
 *
