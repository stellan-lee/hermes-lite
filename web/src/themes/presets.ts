 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `marlow_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Marlow Teal",
  description: "Classic dark teal — the canonical Marlow look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Marlow look, ported from the
 ...
 * nousnet-web's <body> is white; marlow-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Marlow Teal (Large)",
  description: "Marlow Teal with bigger fonts and roomier spacing",
