...
const STORAGE_KEY = "marlow-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `marlow_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "marlow-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-marlow-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-marlow-theme-font", "true");
