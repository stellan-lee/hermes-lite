...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateMarlow: "Mettre à jour Marlow",
    updatingMarlow: "Mise à jour de Marlow…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Marlow (parité avec `marlow plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.marlow/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.marlow/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.marlow/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges Marlow à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Marlow en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Marlow davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Marlow détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Marlow analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
