...
the get_anchored_view / get_messages_around primitives in marlow_state.
...
# Third-party integrations tag their sessions with MARLOW_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from marlow_state import DEFAULT_DB_PATH
