...
# available on every platform Marlow itself runs on.
...
# match a safe prefix, the operational MARLOW_ allowlist, or (on Windows) an
# OS-essential name.
#
...
def _connect():
    ...
    MARLOW_RPC_SOCKET can be either:
...
def execute_code(
    ...
    # selector from MARLOW_RPC_SOCKET (path vs. ``tcp://host:port``).
    ...
    try:
        # Write the auto-generated marlow_tools module.
        ...
        #   connect.  MARLOW_RPC_SOCKET is set to ``tcp://127.0.0.1:<port>``
