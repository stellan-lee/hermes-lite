...
Trust levels:
  - builtin:   Ships with Marlow. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.marlow/\.env|\~/\.marlow/\.env',
     "marlow_env_access", "critical", "exfiltration",
     "directly references Marlow secrets file"),
    ...
    (r'\.marlow/config\.yaml|\.marlow/SOUL\.md',
     "marlow_config_mod", "critical", "persistence",
     "references Marlow configuration files directly"),
...
# scan. `.skillignore` is the Marlow-native name; `.clawhubignore` is honored
