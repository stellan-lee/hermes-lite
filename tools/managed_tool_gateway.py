...
def auth_json_path():
    """Return the Marlow auth store path, respecting MARLOW_HOME overrides."""
    return get_marlow_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`marlow tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from marlow_cli.auth import resolve_nous_access_token
