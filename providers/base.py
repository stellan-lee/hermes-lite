...
def _profile_user_agent() -> str:
    """Return a ``marlow-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from marlow_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"marlow-cli/{_ver}"
    except Exception:
        return "marlow-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # marlow-cli UA so the catalog endpoint is reachable.
