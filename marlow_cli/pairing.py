...
Usage:
    marlow pairing list              # Show all pending + approved users
    marlow pairing approve <platform> <code>  # Approve a pairing code
    marlow pairing revoke <platform> <user_id> # Revoke user access
    marlow pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle marlow pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: marlow pairing {list|approve|revoke|clear-pending}")
        print("Run 'marlow pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.marlow/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'marlow pairing list' to see pending codes.\n")
