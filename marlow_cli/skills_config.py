"""
Skills configuration for Marlow Agent.
`marlow skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.marlow/config.yaml under:
...
from marlow_cli.config import cfg_get, load_config, save_config
from marlow_cli.colors import Colors, color
from marlow_cli.platforms import PLATFORMS as _PLATFORMS
