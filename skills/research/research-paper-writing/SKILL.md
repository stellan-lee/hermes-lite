...
## Marlow Agent Integration

This skill is designed for the Marlow agent. It uses Marlow tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Marlow skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.marlow/plans/` | `skill_view("plan")` |
