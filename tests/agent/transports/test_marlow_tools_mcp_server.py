"""Tests for the marlow-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import marlow_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.marlow_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_expected_marlow_specific_tools_listed(self):
        """The Marlow-specific tools should be present so users on the
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.marlow_tools_mcp_server as m
