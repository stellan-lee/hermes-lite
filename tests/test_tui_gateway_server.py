...
def test_resolve_model_uses_inference_model_env(monkeypatch):
    ...
    monkeypatch.setenv("MARLOW_INFERENCE_MODEL", " local/test-model\n")
...
def test_startup_runtime_uses_tui_provider_env(monkeypatch):
    monkeypatch.setenv("MARLOW_MODEL", "local/test-model")
    monkeypatch.setenv("MARLOW_TUI_PROVIDER", "custom")
...
def test_startup_runtime_does_not_treat_inference_provider_as_explicit(monkeypatch):
    ...
    monkeypatch.setenv("MARLOW_INFERENCE_PROVIDER", "custom")
    monkeypatch.setattr(
...
def test_startup_runtime_detects_provider_for_model_env(monkeypatch):
    monkeypatch.setenv("MARLOW_MODEL", "gpt-5.3-codex")
    monkeypatch.delenv("MARLOW_TUI_PROVIDER", raising=False)
    monkeypatch.delenv("MARLOW_INFERENCE_PROVIDER", raising=False)
