...
The unit tests in tests/marlow_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned marlow-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/marlow")
from marlow_cli.service_manager import S6ServiceManager
