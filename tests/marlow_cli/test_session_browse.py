"""Tests for the interactive session browser (`marlow sessions browse`).
...
from marlow_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """marlow sessions browse should be parseable."""
