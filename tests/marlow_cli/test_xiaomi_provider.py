...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from marlow_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in MARLOW_OVERLAYS
        overlay = MARLOW_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify marlow doctor recognizes Xiaomi env vars."""
