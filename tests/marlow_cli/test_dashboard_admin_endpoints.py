...
def _client():
    ...
    # Keep the state DB under the isolated MARLOW_HOME for any handler that
    # touches it.
...
class TestMcpEndpoints:
    ...
    def _setup(self, _isolate_marlow_home):
...
class TestMemoryEndpoints:
    ...
    def _setup(self, _isolate_marlow_home):
        ...
        (get_marlow_home() / "memories").mkdir(parents=True, exist_ok=True)
...
class TestSystemStatsEndpoint:
    ...
    def test_stats_shape(self):
        ...
        for key in ("os", "arch", "hostname", "python_version", "marlow_version"):
