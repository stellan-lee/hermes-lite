"""Tests for the ``marlow prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from marlow_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(marlow_home, memory_text="", user_text=""):
    mem_dir = marlow_home / "memories"
...
def _seed_skill(marlow_home, name, description):
    skill_dir = marlow_home / "skills" / "demo" / name
