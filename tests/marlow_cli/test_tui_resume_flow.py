...
def test_launch_tui_exports_model_provider_and_toolsets(monkeypatch, main_mod):
    ...
    env = captured["env"]
    assert env["MARLOW_MODEL"] == "local/test-model"
    assert env["MARLOW_INFERENCE_MODEL"] == "local/test-model"
    assert env["MARLOW_TUI_PROVIDER"] == "custom"
    assert env["MARLOW_INFERENCE_PROVIDER"] == "custom"
