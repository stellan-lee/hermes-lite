...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from marlow_cli.models import normalize_provider
...
# =============================================================================
# CANONICAL_PROVIDERS (marlow model picker)
# =============================================================================
...
class TestTencentInOpenRouterAndNous:
    ...
    def test_in_openrouter_fallback(self):
        from marlow_cli.models import OPENROUTER_MODELS
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from marlow_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from marlow_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in MARLOW_OVERLAYS
        overlay = MARLOW_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubDoctor:
    """Verify marlow doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from marlow_cli.providers import MARLOW_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = MARLOW_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``marlow model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from marlow_cli import main as main_mod
...
class TestTencentTokenhubModelCatalogJSON:
    ...
    def test_in_model_catalog_json(self):
        catalog_path = os.path.join(
            ...
            "..", "..",
            "marlow_cli", "data", "model-catalog.json",
        )
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from marlow_cli.models import _KNOWN_PROVIDER_NAMES
