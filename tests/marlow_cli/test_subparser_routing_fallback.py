...
The main() function in marlow_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `marlow -c model`
...
def _build_parser():
    """Build a minimal replica of the marlow top-level parser."""
