...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("marlow_cli.config.get_config_path", return_value=config_path), \
             patch("marlow_cli.config.ensure_marlow_home"):
    ...
    def test_ensure_marlow_home_sets_0700(self):
        home = Path(self.tmpdir) / ".marlow"
        with patch("marlow_cli.config.get_marlow_home", return_value=home):
