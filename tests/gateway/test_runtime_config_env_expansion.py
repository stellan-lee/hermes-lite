...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("MARLOW_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("MARLOW_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("MARLOW_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
