...
def store(tmp_path, monkeypatch):
    ...
    ~/.marlow/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at marlow_state import time, before pytest's MARLOW_HOME monkeypatch
    fires — the autouse fixture's MARLOW_HOME override doesn't help here.)
    """
    import marlow_state
